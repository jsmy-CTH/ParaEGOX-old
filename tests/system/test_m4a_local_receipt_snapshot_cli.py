...
def test_receipt_single_status_locator_latest_and_generation_races_fail_closed() -> None:
    ...
    try:
        ...
        assert replacement_observed == b"SLO"
        ...
        assert replacement_markers == b"SLO", (
            "old locator opened successor bootstrap or attempted Latest"
        )
        ...
        for candidate in (config_path, startup_config):
            with contextlib.suppress(
                AssertionError,
                FileNotFoundError,
                subprocess.SubprocessError,
