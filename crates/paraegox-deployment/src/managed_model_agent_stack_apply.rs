...
mod tests {
    ...
    use super::artifact_external_store::{
        ArtifactExternalControllerAuthorityBindingV1,
        ArtifactExternalControllerAuthorityRecheckFailureV1,
        ArtifactExternalControllerAuthorityV1, ArtifactExternalControllerStoreChangeV1,
        ArtifactExternalControllerStoreFailureV1, ArtifactExternalDeploymentControllerStoreV1,
    };
    use crate::managed_fabric_apply::{
    ...
    fn artifact_external_controller_store_publishes_replays_and_advances_exact_chain() {
        let admitted_fixture = ArtifactExternalControllerStateV2::decode(&decode_fixture_hex(
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../../tests/fixtures/wire/artifact_f0_pxmj_v2_admitted.hex"
            )),
        ...
        .expect("A fixture");
        let committed_fixture = ArtifactExternalControllerStateV2::decode(&decode_fixture_hex(
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../../tests/fixtures/wire/artifact_f0_pxmj_v2_committed.hex"
            )),
        ...
        .expect("C fixture");
        let applying_fixture = ArtifactExternalControllerStateV2::decode(&decode_fixture_hex(
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../../tests/fixtures/wire/artifact_f0_pxmj_v2_applying.hex"
            )),
        ...
        .expect("P fixture");
        let active_fixture = ArtifactExternalControllerStateV2::decode(&decode_fixture_hex(
            include_str!(concat!(
                env!("CARGO_MANIFEST_DIR"),
                "/../../tests/fixtures/wire/artifact_f0_pxmj_v2_active_ready.hex"
            )),
        ...
        let admitted = ArtifactExternalDeploymentControllerStoreV1::admit(
            &mut authority,
            &request,
        );
        assert_eq!(
        ...
        let replayed = ArtifactExternalDeploymentControllerStoreV1::admit(
            &mut authority,
            &request,
        );
        assert_eq!(
        ...
        let committed_result =
            locked.commit_successor(&mut authority, &locked_binding, committed);
        assert_eq!(
        ...
        let applying = committed
            ...
            .expect("P successor");
        let applying_result =
            locked.commit_successor(&mut authority, &locked_binding, applying);
        assert_eq!(
        ...
        let active = applying
            .finish_apply(
                Some(active_fixture.runtime_terminal().expect("R terminal").clone()),
                None,
            )
            .expect("R successor");
