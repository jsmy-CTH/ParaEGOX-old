...
mod tests {
    ...
    fn artifact_external_request_and_admission_match_shared_hardcoded_goldens() {
        ...
        assert_eq!(
            ...
            &[
                0x1f, 0xe2, 0x43, 0xfd, 0x90, 0x34, 0xf0, 0x4d, 0xae, 0xc0, 0xc0, 0x23, 0x66,
                0x1c, 0x6f, 0x3e, 0x8b, 0x48, 0x78, 0xf6, 0xea, 0xab, 0x6b, 0xa0, 0x59, 0x4b,
                0x37, 0x16, 0x1e, 0xc8, 0x8c, 0x1e,
            ],
        );
        let request = ArtifactExternalDeploymentRequestV1::try_new(
            ArtifactDeploymentOperationIdV1::try_from_bytes([0xd1; 16])
                .expect("deployment operation id"),
            ArtifactConfigCommitmentV1::try_from_bytes([0xa1; 32])
